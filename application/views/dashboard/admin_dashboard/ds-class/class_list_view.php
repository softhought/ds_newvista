   ...
   <section class="content-header">
    ...
    <section class="content">
            ...
            <div class="box-header">
              ...
              <a href="<?php echo base_url();?>classlist/addclass" class="link_tab"><span class="glyphicon glyphicon-plus"></span> ADD</a>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
            ...
            <td><?php echo $value->classname; ?></td>
						...
						<td align="center"> 
							<a href="<?php echo base_url(); ?>classlist/addclass/<?php echo $value->id; ?>" class="btn btn-primary btn-xs" data-title="Edit">
