...
.not-found div.wave-1 {
  background: url(../../assets/images/error_img/404/wave-1.svg);
}
.not-found div.wave-2 {
  background: url(../../assets/images/error_img/404/wave-2.svg);
}
.not-found div.wave-3 {
  background: url(../../assets/images/error_img/404/wave-3.svg);
}
.not-found div.wave-4 {
  background: url(../../assets/images/error_img/404/wave-4.svg);
}
.not-found div.wave-5 {
  background: url(../../assets/images/error_img/404/wave-5.svg);
}
.not-found div.wave-6 {
  background: url(../../assets/images/error_img/404/wave-6.svg);
}
.not-found div.wave-7 {
  background: url(../../assets/images/error_img/404/wave-7.svg);
}
.not-found div.sky-bg {
  background: url(../../assets/images/error_img/404/bg-1_gvybzk.svg);
  height: 100%;
}
...
<div class="not-found parallax">
            ...
            <a class="wave-island" href="<?php echo base_url();?>dashboard">
                    <img src="<?php echo base_url(); ?>assets/images/error_img/404/island.svg" alt="Island">
                </a>
            ...
            <div class="wave-boat">
                <img class="boat" src="<?php echo base_url(); ?>assets/images/error_img/404/boat.svg" alt="Boat">
            </div>
            <div class="wave-3"></div>
            <div class="wave-2"></div>
            <div class="wave-1"></div>
            <div class="wave-message">
                <p>Hum! Your're lost</p>
