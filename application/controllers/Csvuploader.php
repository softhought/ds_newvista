...
//                    echo("</pre>");
    ...
    public function listCsvData(){
      ...
      $fromdt = date("Y-m-d", strtotime($this->uri->segment(3)));
      $todt = date("Y-m-d", strtotime($this->uri->segment(4)));
      $classid = $this->uri->segment(5);
      $sectionid = $this->uri->segment(6);
      $studentid = $this->uri->segment(7);
    
          $result_data= $this->csvprocessmodel->get_csv_list($fromdt,$todt,$classid,$sectionid,$studentid);
